...
window.SEED_LESSON_CONTENT = {
 "L1:1.1": {
  ...
  "terms": [
   [
    "Atheism",
    "The lack of belief in any god, which is a statement about a person&rsquo;s own belief rather than a proof that no gods exist."
   ],
   [
    "Agnosticism",
    "The position that the existence of a god is unknown or unknowable, answering the question of knowledge rather than belief."
   ],
   [
    "Antitheism",
    "Active opposition to religion or to belief in gods on the grounds that their influence is harmful, distinct from merely lacking belief."
   ],
   [
    "Igtheism",
    "The view that the word &ldquo;god&rdquo; is too poorly defined to be meaningfully affirmed or denied, so the question must be clarified before it can be answered."
   ]
  ],
  "quiz": [
   {
    "q": "Atheism and agnosticism answer the same underlying question.",
    "opts": [
     "True",
     "False"
    ],
    "ans": 1,
    "ex": "<b>Atheism</b> answers a question about belief (do you believe a god exists?), while <b>agnosticism</b> answers a question about knowledge (can it be known?), so a person can hold both at once."
   },
   {
    "q": "Someone says, &ldquo;I don&rsquo;t hold a belief in any god, but I don&rsquo;t claim to know for certain that none exist.&rdquo; Which label fits best?",
    "opts": [
     "Gnostic theist",
     "Agnostic atheist",
     "Antitheist",
    ...
    "ans": 1,
    "ex": "Lacking belief makes them an atheist; declining to claim certainty makes them agnostic, so the combined stance is <b>agnostic atheism</b>."
   },
   {
    "q": "A debater insists their opponent must &ldquo;prove no gods exist anywhere&rdquo; after the opponent only said they lack belief in any god. What has gone wrong?",
    "opts": [
     "The opponent secretly holds the strong claim",
     "The debater has shifted the burden onto a position the opponent never took",
     "Both positions are actually identical",
     "Agnosticism has been ruled out"
    ],
    "ans": 1,
 ...
 "L1:1.3": {
  ...
  "terms": [
   ...
   [
    "Strong atheism",
    "Position 7 on the scale: the positive claim to <i>know</i> that no God exists, which carries the burden of defending a certain negative existential claim."
   ]
  ],
  "quiz": [
   {
    "q": "The Dawkins Spectrum measures which group a person belongs to rather than how confident they are.",
    "opts": [
     "True",
     "False"
    ],
   ...
   },
   {
    ...
    "opts": [
     "At 7, because he was certain no God exists",
     "At 6 leaning toward 7, because certainty about a negative existential claim is a heavy burden",
     "At 4, because the middle is the most reasonable spot",
     "At 1, because he claimed knowledge of God"
    ],
    "ans": 1,
    "ex": "Dawkins put himself at <b>6</b> (de facto atheist) leaning toward 7, holding back from full certainty because proving a negative existential claim is difficult."
   },
   {
    "q": "In a debate, a speaker defends his own modest position 6 but spends his time attacking the certainty of a position 7 his opponent never claimed. What has he done?",
    "opts": [
     "Correctly held his opponent to their stated number",
     "Committed a bait-and-switch by swapping the claim actually on the table",
     "Proven that the middle of the scale is always right"
    ],
    "ans": 1,
 ...
 "L1:1.4": {
  ...
  "terms": [
   [
    "Category error",
    "Treating something as belonging to a kind it does not belong to, as when the absence of a single belief is mistaken for a complete belief system."
   ],
   [
    "Steelman",
    "The practice of restating an opponent&rsquo;s argument in its strongest, most defensible form before responding to it."
   ],
   [
    "Lack of belief vs. denial",
    "The distinction between not being convinced a claim is true (withholding assent) and positively asserting the claim is false (a stronger commitment)."
   ],
   [
  ...
  "quiz": [
   {
    "q": "&ldquo;Atheism is a religion&rdquo; is best described as which kind of mistake?",
    "opts": [
     "A category error that treats the absence of one belief as a full belief system",
     "A factual error about how many atheists exist",
     "A spelling error",
     "A valid claim with no flaws"
    ],
    "ans": 0,
    "ex": "Atheism answers one question and supplies no rituals, texts, or moral code, so calling it a religion commits a <b>category error</b> by confusing the lack of a belief for a whole worldview."
   },
   {
    "q": "True or False: An atheist who simply lacks belief in a god is logically required to claim certain proof that no god exists.",
    "opts": [
     "True",
     "False"
    ],
    "ans": 1,
    "ex": "False. There is a <b>lack of belief vs. denial</b> distinction: withholding assent to a claim is weaker than positively asserting the claim is false, so most atheists grant they cannot prove a universal negative."
   },
   {
    "q": "When a theist objects that morality needs a divine grounding, what does the lesson recommend as the fair response?",
    "opts": [
     "Mock the objection as obviously wrong",
     "Concede the grounding of ethics is a real question, while noting atheism by itself takes no position on it",
     "Claim atheism contains a complete moral code",
     "Refuse to engage with the point"
    ],
    "ans": 1,
 ...
 "L1:2.1": {
  ...
  "terms": [
   [
    "Premise",
    "A statement offered as a reason or evidence in support of a conclusion."
   ],
   [
    "Conclusion",
    "The statement that an argument is trying to establish, which the premises are meant to support."
   ],
   [
    "Validity",
    "A property of an argument&rsquo;s structure: if all the premises were true, the conclusion would have to be true."
   ],
   [
    "Soundness",
    "A property of an argument that is both valid and has premises that are in fact all true."
   ]
  ],
  "quiz": [
   {
    "q": "An argument can be valid even if its premises are false.",
    "opts": [
     "True",
     "False"
    ],
   ...
   },
   {
    ...
    "opts": [
     "Insist the conclusion is false without saying why",
     "Dispute the truth of one of the premises",
     "Point out that the argument is valid"
    ],
    "ans": 1,
 ...
 "L1:2.2": {
  ...
  "terms": [
   [
    "Deductive reasoning",
    "Inference in which the conclusion is guaranteed true whenever the premises are true, so the argument&rsquo;s force lies in its logical structure."
   ],
   [
    "Inductive reasoning",
    "Inference that generalizes from observed cases to a broader or future conclusion, yielding probability rather than certainty."
   ],
   [
    "Abductive reasoning",
    "Inference to the best explanation, which selects the hypothesis that most economically accounts for a puzzling observation."
   ],
   [
    "Validity vs. soundness",
    "A deductive argument is valid when its form forces the conclusion, and sound when it is both valid and has all true premises."
   ]
  ],
  "quiz": [
   {
    "q": "A valid deductive argument with at least one false premise can still have a true conclusion.",
    "opts": [
     "True",
     "False"
    ],
   ...
   },
   {
    ...
    "opts": [
     "Whether the conclusion follows with logical necessity",
     "Whether it explains the evidence better than rival hypotheses",
 ...
 "L1:2.3": {
  ...
  "terms": [
   [
    "Burden of proof",
    "The obligation to provide supporting evidence rests on the person making a positive claim, not on the person who doubts it."
   ],
   [
    "Hitchens&rsquo;s Razor",
    "The principle that what is asserted without evidence can be dismissed without evidence."
   ],
   [
    "Russell&rsquo;s Teapot",
    "Bertrand Russell&rsquo;s analogy showing that being unable to disprove a claim does not make believing it reasonable, since the claimant still owes the evidence."
   ],
   [
  ...
  "quiz": [
   {
    "q": "In a debate, who carries the burden of proof?",
    "opts": [
     "The person making the positive claim",
     "The person who doubts the claim",
     "Whoever spoke first",
     "Both sides equally, always"
    ],
    "ans": 0,
    "ex": "The <b>burden of proof</b> falls on the person advancing a positive claim. A doubter who is simply unconvinced owes no counter-evidence until a supported case has been made."
   },
   {
    "q": "True or False: If a claim cannot be disproven, that is a good reason to believe it.",
    "opts": [
     "True",
     "False"
    ],
 ...
 "L1:2.4": {
  "read": [
   "Picture two people watching the same garden. One says an invisible gardener tends it; the other doubts any gardener exists. They set traps, wait through the night, and find nothing. The believer responds that this gardener is silent, leaves no scent, and gives way to every fence. By now a fair listener should ask a sharp question: what could the garden ever look like if there were <i>no</i> gardener at all? When a claim has been adjusted to survive every test, the disagreement is no longer about the world. This lesson asks what happens to a claim once it forbids no observation, and why that quietly removes it from the debate.",
   "A claim earns its keep in an empirical argument by taking a risk. To say &ldquo;it will rain here tomorrow&rdquo; is to stick your neck out, because a dry sky would prove you wrong. That exposure is not a weakness; it is the source of the claim&rsquo;s content. The more observations a statement excludes, the more it actually tells us, because it draws a sharp line between the world as described and worlds that are ruled out. A statement compatible with every conceivable result draws no line at all. It cannot be checked, not because the evidence is hard to gather, but because no evidence could ever count for or against it. Such a claim may still be true, deeply felt, or worth holding for other reasons, yet it carries no weight as evidence in a dispute about facts.",
   "In a real exchange, watch for the claim that quietly retreats each time a test comes back negative. A prediction that keeps adding exceptions until nothing could refute it has stopped predicting. The honest move is to ask your opponent, and yourself, one plain question: what observation would you accept as counting against this? If the answer is &ldquo;none,&rdquo; the claim is not thereby false, but it has left the arena of empirical debate and become something else, perhaps a definition or an article of faith. A thoughtful theist can grant this and still defend belief on philosophical or experiential grounds, which is a separate and legitimate move. The error to avoid, on any side, is presenting an unfalsifiable statement as though it were hard-won empirical proof."
  ],
  "terms": [
   [
    "Falsifiability",
    "The property of a claim such that some possible observation, if it occurred, would show the claim to be false."
   ],
   [
    "Empirical content",
    "The amount a claim tells us about the world, measured by how many possible observations it rules out."
   ],
   [
    "Unfalsifiable claim",
    "A statement compatible with every possible observation, so that no evidence could ever count for or against it."
   ],
   [
    "Ad hoc rescue",
    "Patching a refuted claim with an exception added only to evade the counterevidence, rather than for independent reasons."
   ]
  ],
  "quiz": [
   {
    "q": "A claim that is compatible with every possible observation is therefore very strong evidence in a factual debate.",
    "opts": [
     "True",
     "False"
    ],
    "ans": 1,
    "ex": "False. A claim that rules out no observation has zero <b>empirical content</b>; because nothing could ever count against it, nothing can count for it either, so it carries no evidential weight."
   },
   {
    "q": "Which question best tests whether a claim is falsifiable?",
    "opts": [
     "Does the claim feel true to most people?",
     "What observation, if we saw it, would count against this claim?",
     "Has any famous thinker endorsed the claim?",
     "Is the claim phrased confidently?"
    ],
    "ans": 1,
    "ex": "Asking what observation would count against a claim probes its <b>falsifiability</b>; if the honest answer is &ldquo;none,&rdquo; the claim excludes no observation and has left empirical debate."
   },
   {
    "q": "An opponent's prediction fails a test, so they add a new exception with no reason other than to keep the prediction alive. This is best described as:",
    "opts": [
     "A legitimate refinement based on fresh evidence",
     "An ad hoc rescue that erodes falsifiability"
    ],
    "ans": 1,
 ...
 "L1:3.1": {
  ...
  "terms": [
   ...
   [
    ...
    "The invalid move of inferring P from &ldquo;if P then Q&rdquo; together with Q, ignoring that Q may have other causes."
   ],
   [
    "Denying the antecedent",
    "The invalid move of inferring not-Q from &ldquo;if P then Q&rdquo; together with not-P, ignoring that Q may still hold for another reason."
   ],
   [
    "Modus tollens",
    "The valid form that infers not-P from &ldquo;if P then Q&rdquo; together with not-Q."
   ]
  ],
  "quiz": [
   {
    "q": "An argument with all true premises and a true conclusion is automatically valid.",
    "opts": [
     "True",
     "False"
    ],
   ...
   },
   {
    ...
    "opts": [
     "Is valid by modus ponens",
     "Commits affirming the consequent",
     "Commits denying the antecedent",
     "Is valid by modus tollens"
    ],
    "ans": 1,
    "ex": "It affirms the consequent (the street being wet). This is <b>affirming the consequent</b>, since a wet street could have many causes besides rain."
   },
   {
    "q": "Which form is valid?",
    "opts": [
 ...
 "L1:3.2": {
  ...
  "terms": [
   ...
   [
    ...
    "Treating a claim as established because a famous or credentialed person endorsed it, especially outside their field of expertise."
   ],
   [
    "Appeal to ignorance",
    "Arguing that a claim is true because it has not been proven false, or false because it has not been proven true."
   ],
   [
    "Genetic fallacy",
    "Judging a claim as true or false based on its origin or source rather than on its actual merits."
   ]
  ],
  "quiz": [
   {
    "q": "&ldquo;You can&rsquo;t prove that no god exists, so it&rsquo;s reasonable to conclude one does.&rdquo; Which fallacy is this?",
    "opts": [
     "Ad hominem",
     "Appeal to ignorance",
     "Genetic fallacy",
    ...
    "ans": 1,
    "ex": "Treating the lack of disproof as if it were proof is the <b>appeal to ignorance</b>. The absence of a disproof is not evidence for the claim."
   },
   {
    "q": "Pointing out that an argument was first proposed by a religious mystic is, by itself, enough to show the argument is false.",
    "opts": [
     "True",
     "False"
    ],
    "ans": 1,
    "ex": "Dismissing a claim purely because of where it came from is the <b>genetic fallacy</b>. The origin of an argument says nothing about whether its reasoning is sound."
   },
   {
    "q": "A debater cites a Nobel-winning chemist&rsquo;s personal belief in God as proof that God exists. The flaw is best named:",
    "opts": [
     "Appeal to inappropriate authority",
     "Ad hominem",
     "Appeal to emotion",
 ...
 "L1:3.3": {
  ...
  "terms": [
   [
    "False dilemma",
    "Presenting only two options as if they were exhaustive when further alternatives actually exist."
   ],
   [
    "Begging the question",
    "Assuming the very conclusion to be proved as one of the argument's premises, so it proves nothing new."
   ],
   [
    "Equivocation",
    "Shifting the meaning of a key word between premises so an invalid inference appears to follow."
   ],
   [
    "God-of-the-gaps",
    "Treating a current gap in scientific or natural explanation as positive evidence for a designer."
   ]
  ],
  "quiz": [
   {
   ...
   },
   {
    ...
    "opts": [
     "Equivocation on the word &lsquo;law&rsquo;",
 ...
 "L1:3.4": {
  "read": [
   "Imagine two people watch the same heated debate and walk away certain that their side won. They saw identical arguments, yet each came away with the opposite verdict. What happened? The honest answer is that the brain is not a neutral camera recording reality. It is a prediction machine built to keep us alive in groups, and that machinery quietly favors conclusions we already hold. Before we accuse an opponent of dishonesty or stupidity, we should ask a harder question: how much of my own confidence is reasoning, and how much is just my brain rewarding me for agreeing with myself?",
   "Three habits do most of the damage. <b>Confirmation bias</b> is our tendency to seek, notice, and remember evidence that fits what we believe while skimming past what does not. <b>Motivated reasoning</b> goes one step further: when we want a conclusion, we set a low bar for evidence that supports it and a high bar for evidence against it, so the verdict is set before the weighing starts. <b>Agency detection</b> is our reflex to read intention into events, hearing footsteps in the wind, seeing a face in the clouds. These are not signs of a broken mind. They are efficient shortcuts that served our ancestors well, which is exactly why they are so hard to switch off.",
   "In a real debate, watch for these tells in yourself first. If every fact you encounter seems to confirm your view, you are probably filtering, not reasoning. If you can recite your opponent&rsquo;s evidence but never feel its pull, motivated reasoning may be guarding the gate. And when someone explains a complex outcome by reaching straight for a hidden designer or hidden conspiracy, ask whether that is the evidence speaking or an agency reflex firing. The charitable move is to grant that a thoughtful theist or atheist is just as subject to these biases as you are. None of this proves any conclusion false. It only tells us that strong conviction is cheap, and that the work of honest argument is checking the conviction we already have."
  ],
  "terms": [
   [
    "Confirmation bias",
    "The tendency to search for, favor, and recall information that supports what we already believe while overlooking evidence that challenges it."
   ],
   [
    "Motivated reasoning",
    "Reasoning aimed at reaching a desired conclusion, where we demand weak evidence for what we want to be true and strong evidence for what we do not."
   ],
   [
    "Agency detection",
    "The mind&rsquo;s reflex to attribute events to a deliberate agent or intention, even when the cause is impersonal or random."
   ],
   [
    "Steelmanning",
    "Restating an opponent&rsquo;s argument in its strongest, most charitable form before responding to it."
   ]
  ],
  "quiz": [
   {
    "q": "Confirmation bias mainly describes a deliberate choice to lie about evidence.",
    "opts": [
     "True",
     "False"
    ],
    "ans": 1,
    "ex": "False. <b>Confirmation bias</b> is largely automatic and unconscious; we genuinely notice and remember supporting evidence more readily, without intending to deceive anyone."
   },
   {
    "q": "A debater says, &lsquo;I&rsquo;ll accept evidence for my view at face value, but every study against it must be airtight first.&rsquo; Which bias is this?",
    "opts": [
     "Agency detection",
     "Motivated reasoning",
     "Steelmanning"
    ...
    "ans": 1,
    "ex": "This is <b>motivated reasoning</b>: setting a low evidence bar for the desired conclusion and a high bar for the unwanted one, so the verdict is fixed before the weighing begins."
   },
   {
    "q": "Hearing a twig snap in the dark and instantly assuming someone is there is an example of which tendency?",
    "opts": [
     "Agency detection",
     "Confirmation bias",
     "Steelmanning",
 ...
 "L1:4.1": {
  ...
  "terms": [
   [
    "Cārvāka",
    "An ancient Indian materialist school that accepted direct perception as the only reliable source of knowledge and rejected claims about gods, souls, and an afterlife as unverifiable."
   ],
   [
    "Empiricism",
    "The view that knowledge must be grounded in sensory experience and evidence rather than in tradition, authority, or untestable assertion."
   ],
   [
    "Epicureanism",
    "A Greek philosophy holding that the universe is made of atoms moving in void, that the gods are blissful and uninvolved in human life, and that freedom from fear is the path to a good life."
   ],
   [
    "Problem of evil",
    "The argument, sharpened by Lucretius, that the amount of needless suffering in the world counts as evidence against a creator who is both perfectly good and all-powerful."
   ]
  ],
  "quiz": [
   {
    "q": "The Cārvāka school treated perception as the most reliable source of knowledge and was skeptical of claims that could not be observed.",
    "opts": [
     "True",
     "False"
    ],
    "ans": 0,
    "ex": "Correct. <b>Cārvāka</b> was an empiricist school that accepted direct perception as the surest basis for knowledge and challenged the justification of inference and unobservable claims."
   },
   {
    "q": "What was the core point of the Epicurean argument about the gods?",
    "opts": [
     "The gods do not exist and belief in them is foolish",
     "If the gods exist, they are self-sufficient and have no reason to meddle in human affairs, so fear of them is unwarranted",
     "The gods created the world but then abandoned it as punishment",
     "Only one god exists, and it is hidden from human perception"
    ],
    "ans": 1,
    "ex": "Epicurus argued that perfect, blissful gods would have no need to manage human affairs. This <b>distant gods</b> argument was aimed at dissolving fear, not at proving that no divine being exists at all."
   },
   {
    "q": "Which thinker is most associated with arguing that the world's abundant suffering and waste count as evidence against a perfectly good and all-powerful creator?",
    "opts": [
     "Cārvāka",
     "Lucretius",
     "Epicurus"
 ...
 "L1:4.2": {
  ...
  "terms": [
   ...
   [
    ...
    "Kant&rsquo;s term for the inability to think for oneself when the cause is not lack of capacity but lack of resolve to use it."
   ],
   [
    "Deism",
    "The view, common among the philosophes, that a rational God created an orderly universe knowable through reason and nature rather than through revelation or miracles."
   ],
   [
    "Hume&rsquo;s argument on miracles",
    "The claim that since uniform experience supports the laws of nature, testimony to a miracle must be weighed against that experience and rarely outweighs it."
   ]
  ],
  "quiz": [
   {
    "q": "Kant&rsquo;s &lsquo;Sapere aude&rsquo; primarily calls for the rejection of religious belief.",
    "opts": [
     "True",
     "False"
    ],
   ...
   },
   {
    ...
    "opts": [
     "An atheist who denied any divine reality",
     "Identified God with the whole of nature while seeking the intellectual love of God",
     "A traditional theist defending biblical miracles",
   ...
   },
   {
    ...
    "opts": [
     "Because miracles are logically impossible",
     "Because no one has ever claimed to witness one",
     "Because uniform experience supports the laws of nature, so such testimony must be weighed against that experience",
 ...
 "L1:4.3": {
  ...
  "terms": [
   [
    "Secularism",
    "The principle, named by George Holyoake, that public life, ethics, and law should be ordered by reasons accessible to everyone rather than by religious revelation."
   ],
   [
   ...
   [
    "New Atheism",
    "An early-2000s current that treated religious belief as an empirical claim and argued it should be openly criticised on the same evidential standards as any other claim."
   ],
   [
    "The Four Horsemen",
    "The informal name for Richard Dawkins, Daniel Dennett, Sam Harris, and Christopher Hitchens, after a 2007 filmed conversation among them."
   ]
  ],
  "quiz": [
   {
    "q": "Who is credited with coining the term &ldquo;secularism&rdquo;?",
    "opts": [
    ...
    "ans": 1,
    "ex": "<b>George Holyoake</b> introduced the word in the nineteenth century to name an ethics and politics grounded in human welfare rather than revelation. The others belong to later phases of the movement."
   },
   {
    "q": "True or False: Supporting a politically secular state logically requires denying that God exists.",
    "opts": [
     "True",
     "False"
    ],
   ...
   },
   {
    ...
    "opts": [
     "Holyoake, Ingersoll, Russell, and Sagan",
     "Dawkins, Dennett, Harris, and Hitchens",
     "Hume, Voltaire, Paine, and Mill"
    ],
    "ans": 1,
 ...
 "L1:4.4": {
  ...
  "terms": [
   [
    "Freethought",
    "The practice of forming beliefs about religion and morality on the basis of reason and evidence rather than authority, tradition, or revelation."
   ],
   [
    "C&amacr;rv&amacr;ka",
    "An ancient Indian materialist school that rejected an afterlife and supernatural authority, showing that systematic religious skepticism arose independently outside the West."
   ],
   [
    "Apostasy",
    "The formal abandonment or renunciation of a religion, which in some societies is socially tolerated and in others carries severe legal or physical penalty."
   ],
   [
    "Secularism",
    "The principle that the state and public institutions should be neutral on religious questions, which protects both believers and nonbelievers rather than favoring unbelief."
   ]
  ],
  "quiz": [
   {
    "q": "Systematic religious skepticism is a modern Western invention with no real precedent in other cultures.",
    "opts": [
     "True",
     "False"
    ],
    "ans": 1,
    "ex": "False. Schools such as India&rsquo;s <b>C&amacr;rv&amacr;ka</b> defended a materialist, this-world view roughly two and a half thousand years ago, showing freethought arose independently of the European Enlightenment."
   },
   {
    "q": "What does <b>secularism</b>, properly understood, aim to do?",
    "opts": [
     "Abolish religion from private life",
     "Keep public institutions neutral so both believers and nonbelievers are protected",
     "Establish atheism as the official position of the state"
    ],
    "ans": 1,
    "ex": "<b>Secularism</b> asks the state to take no side on religious truth; it shields the freethinker and the faithful alike, rather than promoting unbelief as an official creed."
   },
   {
    "q": "When discussing how a nonbeliever should live in a religious society, which distinction does this lesson urge you to keep separate?",
    "opts": [
     "Whether a belief is true, whether holding it is understandable, and whether dissent from it is safe",
     "Whether a religion is old, whether it is popular, and whether it is wealthy",
     "Whether a believer is sincere, educated, and friendly"
    ],
    "ans": 0,
 ...
 "L2:1.1": {
  ...
  "terms": [
   [
    ...
    "An argument that whatever begins to exist has a cause, the universe began to exist, and therefore the universe has a cause."
   ],
   [
    "Principle of Sufficient Reason",
    "The claim that every fact or existing thing has an explanation for why it is so and not otherwise."
   ],
   [
    "Contingent being",
    "Something that exists but could have failed to exist, and so depends on something else to explain why it exists at all."
   ],
   [
    "Per se causal series",
    "A chain of causes in which each member depends on a prior cause acting at the same moment, as opposed to a sequence stretched out over time."
   ]
  ],
  "quiz": [
   {
    "q": "The Kalam, Leibnizian contingency, and Thomistic arguments all start from the same premise about the universe having a beginning.",
    "opts": [
     "True",
     "False"
    ],
    "ans": 1,
    "ex": "False. Only the <b>Kalam</b> argues from a beginning; Leibniz argues from contingency and the Principle of Sufficient Reason, while the <b>Thomistic ways</b> argue from present-moment dependence and can even grant an eternal universe."
   },
   {
    "q": "Which premise does the Kalam argument actually defend, making &lsquo;what caused God?&rsquo; a misfire as a rebuttal?",
    "opts": [
     "Everything that exists has a cause",
     "Whatever begins to exist has a cause",
     "Every contingent thing has an explanation"
    ],
    "ans": 1,
    "ex": "The Kalam premise is that <b>whatever begins to exist</b> has a cause, so a beginningless being is the proposed exception rather than a violation of the rule."
   },
   {
    "q": "What kind of causal series do the Thomistic ways rely on to reach a first member?",
    "opts": [
     "A temporal series stretching back through past events",
     "A per se series in which each member is sustained by a prior cause acting now",
     "A random series with no dependence between members"
    ],
    "ans": 1,
 ...
 "L2:1.2": {
  ...
  "terms": [
   [
    ...
    "An argument that infers a designer from the apparent purpose, order, or goal-directedness observed in nature."
   ],
   [
    "Fine-tuning",
    "The observation that the fundamental constants of physics fall within a narrow range that permits stars, chemistry, and life."
   ],
   [
    "Anthropic principle",
    "The point that any observers must find themselves in conditions compatible with their own existence, so we should expect to observe a life-permitting universe whatever the explanation."
   ],
   [
    "Multiverse",
    "The hypothesis that many universes with varying constants exist, so that at least one life-permitting universe is unsurprising and we necessarily inhabit it."
   ]
  ],
  "quiz": [
   {
    "q": "The word &ldquo;teleological&rdquo; comes from the Greek <i>telos</i>, meaning end, goal, or purpose.",
    "opts": [
     "True",
     "False"
    ],
    "ans": 0,
    "ex": "Correct. The <b>teleological argument</b> reasons from apparent purpose or goal-directedness (<i>telos</i>) in nature to a designer behind it."
   },
   {
    "q": "In its strongest form, what is the fine-tuning argument actually claiming about the life-permitting values of the constants?",
    "opts": [
     "That chance is logically impossible as an explanation",
     "That a designer explains them better than chance does, because they are improbable",
     "That complex objects always require a maker",
     "That the constants prove a designer with mathematical certainty"
    ],
    "ans": 1,
    "ex": "The steelmanned <b>fine-tuning</b> argument is comparative and probabilistic: it claims a designer predicts a life-permitting universe better than blind chance, not that chance is impossible or that the conclusion is certain."
   },
   {
    "q": "Which reply turns the improbability of the constants into a selection effect by proposing many universes with varying values?",
    "opts": [
     "Paley&rsquo;s watch analogy",
     "The anthropic principle alone",
 ...
 "L2:1.3": {
  ...
  "terms": [
   [
    ...
    "An argument that tries to establish God&rsquo;s existence from the concept or definition of God alone, using reason rather than observation of the world."
   ],
   [
    "That than which nothing greater can be conceived",
    "Anselm&rsquo;s definition of God, which functions as the starting premise from which he argues that such a being must exist in reality."
   ],
   [
    "Maximally great being",
    "Plantinga&rsquo;s term for a being that exists necessarily and has its perfections (such as omnipotence and omniscience) in every possible world."
   ],
   [
    "Possible world",
    "A complete, consistent way reality could have been; in modal logic a claim is necessary if it holds in every possible world and possible if it holds in at least one."
   ]
  ],
  "quiz": [
   {
    "q": "Anselm&rsquo;s ontological argument tries to prove God exists by observing design and order in the physical world.",
    "opts": [
     "True",
     "False"
    ],
   ...
   },
   {
    ...
    "opts": [
     ...
     "That a maximally great being is at least possible",
     "That existence is a perfection greater than non-existence",
     "That moral duties require a lawgiver"
    ],
    "ans": 1,
    "ex": "Plantinga&rsquo;s argument turns on the <b>possibility premise</b>: if a maximally great being is even possible, then by the logic of necessity it exists in every possible world, including this one. Conceding that one premise concedes the conclusion."
   },
   {
    "q": "What is the most effective line of attack against Plantinga&rsquo;s argument in a debate?",
    "opts": [
     "Showing the argument is logically invalid",
     "Denying that the possibility premise is obviously true, since impossibility is equally coherent",
     "Proving the universe is eternal"
    ],
    "ans": 1,
 ...
 "L2:1.4": {
  ...
  "terms": [
   [
    "Moral argument",
    "the claim that objective moral facts exist and are best explained by a personal God who grounds them."
   ],
   [
    "Qualia",
   ...
   [
    ...
    "the question of why physical brain processes are accompanied by any inner experience at all, rather than none."
   ],
   [
    "Inference to the best explanation",
    "an argument form that favours the hypothesis which most simply and completely accounts for the evidence, without claiming certainty."
   ]
  ],
  "quiz": [
   {
    "q": "The moral argument, as commonly stated, concludes that God exists from the premise that objective moral facts exist and require grounding.",
    "opts": [
     "True",
     "False"
    ],
   ...
   },
   {
    ...
    "opts": [
     "Concede that morality is just personal opinion",
     "Offer a secular grounding for objective morality that needs no deity",
     "Argue that no one really knows right from wrong",
     "Claim that science has already disproven God"
    ],
    "ans": 1,
    "ex": "Conceding that morality is opinion hands the theist the <b>objectivity premise</b> for free. The strong move is to grant that some moral facts are objective and show they can be grounded in, say, the suffering of sentient beings without invoking God."
   },
   {
    "q": "The &ldquo;hard problem of consciousness&rdquo; refers to:",
    "opts": [
     "Why brains are difficult to study",
     "Why there is subjective experience at all, rather than mere processing in the dark",
     "How neurons fire electrically",
 ...
 "L2:2.1": {
  ...
  "terms": [
   [
    ...
    "Any argument that infers a first or sufficient cause of the universe from the existence and causal structure of the things within it."
   ],
   [
    "Kalām cosmological argument",
    "A specific version holding that whatever begins to exist has a cause, that the universe began to exist, and therefore that the universe has a cause."
   ],
   [
    "Actual infinite",
    "A completed, fully existing infinite collection (as opposed to a process that increases without limit), whose possibility is the contested premise behind rejecting an eternal past."
   ],
   [
    "Composition fallacy",
    "The error of assuming that what is true of every part of a whole must therefore be true of the whole itself."
   ]
  ],
  "quiz": [
   {
    "q": "The objection &ldquo;who caused God?&rdquo; is a decisive refutation of the cosmological argument.",
    "opts": [
     "True",
     "False"
    ],
    "ans": 1,
    "ex": "False. Because God is <b>defined as uncaused</b>, the question misfires as a knockout blow. The stronger reply is to ask why the universe cannot be granted the same exemption, exposing the argument&rsquo;s special pleading rather than dismissing it."
   },
   {
    "q": "Reasoning from &lsquo;every part of the universe has a cause&rsquo; to &lsquo;the universe as a whole has a cause&rsquo; is an example of which error?",
    "opts": [
     "The genetic fallacy",
   ...
   },
   {
    ...
    "opts": [
     "That it is uncaused",
     "That it is a personal, intelligent being",
     "That it precedes its effects"
    ],
    "ans": 1,
 ...
 "L2:2.2": {
  ...
  "terms": [
   [
    ...
    "The claim that life-permitting physical constants fall within an improbably narrow range and therefore point to a deliberate designer."
   ],
   [
    "Anthropic principle",
    "The observation that any cosmos we are able to observe must be one whose conditions permit observers like us, making our existence an inevitable selection effect rather than a coincidence to be explained."
   ],
   [
    "Multiverse",
    "The hypothesis that physical reality comprises many regions or universes with differing constants, so that life-permitting ones arise somewhere without needing to be aimed at."
   ],
   [
    "Sub-optimal design",
    "The observation that the cosmos and living organisms contain waste, hostility to life, and inefficient &lsquo;kludges&rsquo; that fit an unguided process better than a competent engineer."
   ]
  ],
  "quiz": [
   {
    "q": "The anthropic principle, on its own, fully explains why a life-permitting universe exists.",
    "opts": [
     "True",
     "False"
    ],
    "ans": 1,
    "ex": "False. The <b>anthropic principle</b> is an observer-selection effect: it explains why we could only ever find ourselves in a life-permitting region, but it does not by itself explain why any such region exists. It works best paired with the <b>multiverse</b> or with uncertainty about whether the constants could differ."
   },
   {
    "q": "What is the main role the multiverse plays in answering the fine-tuning argument?",
    "opts": [
     "It proves that no designer could possibly exist",
     "It supplies many regions with varying constants, so a life-permitting one is unsurprising without aiming",
     "It shows the physical constants are actually identical everywhere",
   ...
   },
   {
    ...
    "opts": [
     "Because waste and biological kludges are better predicted by an unguided process than by a flawless engineer",
     "Because it proves the constants are not fine-tuned at all",
     "Because it shows life is impossible",
 ...
 "L2:2.3": {
  "read": [
   "The ontological argument tries to prove God exists from the concept of God alone, with no appeal to evidence about the world. Anselm&rsquo;s version runs roughly like this: God is that than which nothing greater can be conceived; a being that exists in reality is greater than one existing only in the mind; so if God existed only as an idea, we could conceive of something greater, which is a contradiction. The conclusion is that God must exist. The argument is elegant and unsettling because it seems to pull a real being out of a pure definition. This lesson asks a narrow question: when a theist offers it, what are the strongest replies, and what do they actually show?",
   "Three objections have done the heavy lifting. Gaunilo, writing in Anselm&rsquo;s own day, ran the same logic on a perfect island and concluded that defining the greatest possible island forces it into existence too, which is absurd; if the form of reasoning proves too much, something is wrong with the form. Kant pressed deeper: he argued that &lsquo;exists&rsquo; is not a predicate, not a property that makes a concept greater. Saying a hundred real coins exist adds nothing to the concept of a hundred coins; it only claims the concept is instantiated. If existence is not a great-making feature, the argument&rsquo;s key move collapses. Modern parody objections generalize Gaunilo, building &lsquo;greatest conceivable&rsquo; versions of anything to expose the trick.",
   "In a live debate, the work is in the details. A defender will note that Anselm later distinguished necessary existence from mere existence and that islands, being contingent, cannot have a &lsquo;greatest&rsquo; member the way perfection-as-such might. So press the parody where it bites: does the theist&rsquo;s definition smuggle in necessary existence, and is that coherent? On Kant, watch for the reply that necessary existence, unlike plain existence, might be a genuine predicate. Your job is not to mock the argument but to locate the exact premise carrying the weight, then ask whether it is true rather than merely defined into the conclusion. A clean win names the premise; a weak win just feels clever."
  ],
  "terms": [
   [
    "Ontological argument",
    "An a priori argument that God&rsquo;s existence follows from the very concept of God, without appeal to empirical evidence."
   ],
   [
    "Gaunilo&rsquo;s island",
    "A reductio that applies Anselm&rsquo;s reasoning to a &lsquo;greatest conceivable island,&rsquo; arguing that if the form proves an island into existence it proves too much."
   ],
   [
    "Existence is not a predicate",
    "Kant&rsquo;s claim that asserting a thing exists adds no property to its concept but only says the concept is instantiated, so existence cannot be a great-making feature."
   ],
   [
    "Parody objection",
    "A counterargument that mimics an argument&rsquo;s structure with a different subject to show the form generates absurd conclusions."
   ]
  ],
  "quiz": [
   {
    "q": "Kant&rsquo;s core objection to the ontological argument is that &lsquo;existence&rsquo; functions as a property that makes a concept greater.",
    "opts": [
     "True",
     "False"
    ],
    "ans": 1,
    "ex": "False. Kant argued the opposite: <b>existence is not a predicate</b>, so claiming a thing exists adds nothing to its concept and cannot count as a great-making feature."
   },
   {
    "q": "What is Gaunilo&rsquo;s strategy against the ontological argument?",
    "opts": [
     "He denies that God is the greatest conceivable being",
     "He applies the same reasoning to a perfect island to show the form proves too much",
     "He argues that existence cannot be conceived at all",
     "He claims the argument relies on empirical evidence"
    ],
    "ans": 1,
    "ex": "Gaunilo uses a <b>parody objection</b>: running Anselm&rsquo;s logic on a &lsquo;greatest conceivable island&rsquo; yields an absurd conclusion, suggesting the argument&rsquo;s form is flawed."
   },
   {
    "q": "A charitable defender of the argument can resist Gaunilo by claiming which distinction matters?",
    "opts": [
     "The difference between necessary existence and mere contingent existence",
     "The difference between belief and knowledge",
     "The difference between islands and continents"
    ],
    "ans": 0,
 ...
 "L2:2.4": {
  ...
  "terms": [
   ...
   [
    "Moral argument",
    "The argument that objective moral values exist, that such values require God as their source, and therefore that God exists."
   ],
   [
    "Divine command theory",
    "The view that an action is right or wrong solely because God commands or forbids it, making moral facts depend entirely on God&rsquo;s will."
   ],
   [
    "Grounding problem",
    "The challenge of explaining what makes something genuinely good, which persists even after appealing to God&rsquo;s nature rather than God&rsquo;s commands."
   ]
  ],
  "quiz": [
   {
    "q": "In Plato&rsquo;s dialogue, what does Socrates actually ask Euthyphro?",
    "opts": [
     "Whether the gods exist at all",
     "Whether an act is good because the gods command it, or commanded because it is good",
     "Whether morality can be taught",
     "Whether the gods agree with one another"
    ],
    "ans": 1,
   ...
   },
   {
    ...
    "ans": 1,
    "ex": "False. On <b>divine command theory</b>, &ldquo;God is good&rdquo; collapses into &ldquo;God commands what God commands,&rdquo; an empty tautology that praises nothing."
   },
   {
    "q": "If a theist says goodness is grounded in God&rsquo;s nature rather than His commands, what is the sharpest follow-up?",
    "opts": [
     "Asking whether God exists",
     "Asking what makes that nature good, and whether some quality would be good on its own",
     "Pointing out that believers behave morally",
     "Demanding proof of objective morality"
    ],
    "ans": 1,
 ...
 "L2:3.1": {
  "read": [
   "Can a god who is all-powerful, all-knowing, and perfectly good exist alongside the evil we plainly observe? This is the question the &ldquo;logical&rdquo; problem of evil presses, and it is sharper than the everyday complaint that the world contains suffering. The claim is not that evil makes a god unlikely; it is that the very combination is contradictory, the way a married bachelor is. If the inconsistency can be demonstrated, no amount of devotion saves the position. So the debate turns on a precise question: do the three divine attributes, together with the simple fact that evil exists, actually entail a contradiction, or only seem to?",
   "Epicurus framed the tension as a dilemma, and J. L. Mackie sharpened it into a formal charge of inconsistency: a wholly good being would eliminate evil as far as it could, an omnipotent being can do whatever is logically possible, so an omnipotent and wholly good being would leave no evil. Mackie added &ldquo;quasi-logical&rdquo; bridging premises to force the contradiction. Alvin Plantinga&rsquo;s free-will defence answers not by explaining why God permits evil, but by showing the set is consistent: if genuinely free creatures are valuable, even omnipotence cannot guarantee they always choose well, since forcing a free choice is not a coherent task. One possible reason suffices to break a claim of strict contradiction.",
   "In a live debate, watch the burden of proof. The logical problem is an attack on consistency, so the theist need only produce a possible scenario in which all the claims hold together, not a probable or actual one. A common error is demanding that the free-will defence be true or comforting; that mistakes this argument for the separate evidential problem. Two further pressure points decide rounds: whether omnipotence sensibly includes doing the logically impossible, and whether natural evils like disease can be tied to freedom at all. Press those, and concede that most philosophers now grant the strictly logical version has been blunted."
  ],
  "terms": [
   [
    "Logical problem of evil",
    "The argument that the existence of evil is strictly inconsistent with the existence of an omnipotent, omniscient, and wholly good God, so that the two cannot both be true."
   ],
   [
    "Free-will defence",
    "Plantinga&rsquo;s reply that creaturely free will is a genuine good, and a being who freely does good cannot be guaranteed to do so by force, so God&rsquo;s permitting some evil is logically consistent with His goodness and power."
   ],
   [
    "Defence versus theodicy",
    "A defence aims only to show the theist&rsquo;s claims could all be true together, whereas a theodicy tries to give the actual reason God permits evil."
   ],
   [
    "Omnipotence",
    "The power to do anything logically possible, which on the standard view does not include performing self-contradictory tasks such as making a free creature freely choose a particular way."
   ]
  ],
  "quiz": [
   {
    "q": "The logical problem of evil claims only that evil makes the existence of God improbable.",
    "opts": [
     "True",
     "False"
    ],
    "ans": 1,
    "ex": "False. The <b>logical problem of evil</b> claims an outright contradiction between God and evil, not mere improbability; the probability claim belongs to the separate evidential problem."
   },
   {
    "q": "What does Plantinga&rsquo;s free-will defence need to establish to defeat the logical problem?",
    "opts": [
     "That free will actually explains all the evil we observe",
     "That God&rsquo;s existence is more probable than not",
     "That it is merely possible for God and evil to coexist",
     "That evil does not really exist"
    ],
    "ans": 2,
    "ex": "Because the charge is strict inconsistency, the <b>free-will defence</b> succeeds by showing it is logically possible for all the claims to hold together; it need not be true or probable."
   },
   {
    "q": "On the standard account, why does omnipotence not undercut the free-will defence?",
    "opts": [
     "Because God is not actually all-powerful",
     "Because guaranteeing a free creature&rsquo;s choice is logically impossible, and omnipotence does not cover the impossible",
     "Because free will is an illusion",
     "Because evil is not really bad"
    ],
    "ans": 1,
 ...
 "L2:3.2": {
  ...
  "terms": [
   [
    ...
    "The claim that the extent and apparent pointlessness of suffering is strong inductive evidence against the existence of an all-powerful, all-knowing, all-good God, rather than a strict logical contradiction."
   ],
   [
    "Gratuitous suffering",
    "Suffering that an omnipotent being could have prevented without thereby losing a greater good or permitting an evil equally bad or worse."
   ],
   [
    "Noseeum inference",
   ...
   [
    "Skeptical theism",
    "The reply that, given our cognitive limits relative to God, our inability to discern a reason for an evil is poor evidence that no such reason exists."
   ]
  ],
  "quiz": [
   {
    "q": "How does the evidential problem of evil differ from the logical problem of evil?",
    "opts": [
     "It claims God and evil are strictly contradictory",
     "It treats suffering as inductive evidence against God rather than a logical contradiction",
     "It denies that any evil exists",
   ...
   },
   {
    ...
    "opts": [
     "The premise that a good God would prevent preventable pointless suffering",
     "The premise that at least some intense suffering is genuinely gratuitous"
    ],
    "ans": 1,
    "ex": "Premise (2), that a good God would prevent pointless suffering, is widely granted; the burden rests on premise (1), the inductive judgment that some suffering is truly <b>gratuitous</b> and serves no outweighing good."
   },
   {
    "q": "True or False: Rowe claimed to have logically proven that gratuitous suffering exists.",
    "opts": [
     "True",
     "False"
    ],
 ...
 "L2:3.3": {
  ...
  "terms": [
   [
    "Theodicy",
    "An attempted explanation of why an all-good, all-powerful God would permit the evil and suffering that actually exists."
   ],
   [
    "Soul-making theodicy",
    "John Hick's view that a world containing real hardship is necessary for developing moral and spiritual character that a painless world could not produce."
   ],
   [
    "Greater-good defense",
    "The claim that every evil God permits is logically necessary to secure an outweighing good or to prevent an even greater evil."
   ],
   [
    "Skeptical theism",
    "The position that human beings are too cognitively limited to survey all possible goods, so failing to find a justification for an evil is not evidence that none exists."
   ]
  ],
  "quiz": [
   {
    "q": "Soul-making theodicy claims that a world without any hardship would still produce people of deep moral character.",
    "opts": [
     "True",
     "False"
    ],
    "ans": 1,
    "ex": "False. <b>Soul-making theodicy</b> holds the opposite: genuine hardship is the necessary condition for developing virtues like courage and compassion, which a frictionless world could not generate."
   },
   {
    "q": "What is the core move of skeptical theism in response to the problem of evil?",
    "opts": [
     "It denies that any real suffering exists",
     "It argues that our limited grasp of possible goods means failing to see a justification is not proof there is none",
     "It claims every evil produces a visible good we can identify",
     "It concedes God is not all-powerful"
    ],
    "ans": 1,
    "ex": "<b>Skeptical theism</b> grants we cannot identify the justifying good for a given evil but denies this counts as evidence that no such good exists, since our cognitive reach over possible goods is limited."
   },
   {
 ...
 "L2:4.1": {
  ...
  "terms": [
   [
    "Natural selection",
    "The non-random survival and reproduction of organisms whose inherited traits better fit their environment, causing those traits to spread over generations."
   ],
   [
    "Irreducible complexity",
    "The claim that certain biological systems would stop functioning if any single part were removed, and so could not have evolved gradually."
   ],
   [
    "Co-option (exaptation)",
    "The evolutionary process in which a feature that evolved for one function is later repurposed for a different one."
   ],
   [
    "Argument from design",
    "The inference that the apparent purpose and complexity of living things points to an intelligent designer as their cause."
   ]
  ],
  "quiz": [
   {
    "q": "Natural selection works purely by random chance.",
    "opts": [
     "True",
     "False"
    ],
    "ans": 1,
    "ex": "<b>Natural selection</b> is non-random: mutation supplies undirected variation, but selection systematically preserves variants that reproduce more successfully."
   },
   {
    "q": "What is the strongest reply to the claim that a system is &ldquo;irreducibly complex&rdquo;?",
    "opts": [
     "The system is too simple to matter",
     "Its parts may have had earlier, different functions before being co-opted",
     "Complexity proves a designer",
     "No reply is possible"
    ],
    "ans": 1,
    "ex": "<b>Co-option</b> shows that removing a part today reveals nothing about its history, since parts can be repurposed from earlier functions."
   },
   {
    "q": "Which move should you watch for when an opponent argues from design?",
    "opts": [
     "Offering a testable prediction",
     "Quietly shifting the design claim from biology to cosmology mid-argument",
     "Defining their terms clearly",
     "Conceding partial functions exist"
    ],
    "ans": 1,
 ...
 "L2:4.2": {
  ...
  "terms": [
   [
    "Big Bang",
    "The well-supported scientific model that the observable universe expanded from an extremely hot, dense state about 13.8 billion years ago."
   ],
   [
    "Cosmic microwave background",
    "The faint, uniform radiation left over from the early universe, treated as primary evidence for the Big Bang model."
   ],
   [
    "Fine-tuning",
    "The observation that certain physical constants fall within narrow ranges that allow stars, chemistry, and life to exist."
   ],
   [
    "Quantum vacuum",
    "A physical state governed by quantum fields that, despite being called &ldquo;empty,&rdquo; is not the philosopher&rsquo;s absolute nothingness."
   ]
  ],
  "quiz": [
   {
    "q": "The Big Bang model claims the universe was created out of absolute, philosophical nothingness.",
    "opts": [
     "True",
     "False"
    ],
    "ans": 1,
    "ex": "False. The <b>Big Bang</b> describes the expansion of the universe from a hot, dense early state; it does not, by itself, assert creation from absolute nothingness. That metaphysical claim is a separate debate."
   },
   {
    "q": "In the &ldquo;something from nothing&rdquo; debate, what equivocation should a careful listener watch for?",
    "opts": [
     "Treating the physicist&rsquo;s quantum vacuum as identical to the philosopher&rsquo;s absolute nothing",
     "Confusing the speed of light with the speed of sound",
     "Assuming galaxies are stationary rather than moving",
     "Mixing up the age of the Earth with the age of the universe"
    ],
    "ans": 0,
    "ex": "A <b>quantum vacuum</b> is a structured physical state with fields and energy, not the total absence of anything. Sliding between the two senses of &ldquo;nothing&rdquo; can make an argument look stronger than it is."
   },
   {
    "q": "Which is the strongest secular response to the fine-tuning argument?",
    "opts": [
     "Denying that any physical constants exist",
     "Granting the observation but noting that &lsquo;unlikely&rsquo; does not automatically mean &lsquo;designed,&rsquo; given live alternatives",
     "Claiming the universe shows no order of any kind",
     "Insisting the Big Bang has been disproven"
    ],
    "ans": 1,
 ...
 "L2:4.3": {
  ...
  "terms": [
   [
    ...
    "the working rule of seeking only testable natural causes in inquiry, while staying silent on whether anything supernatural exists."
   ],
   [
   ...
   [
    "Bracketing",
    "setting a question aside as outside a method&rsquo;s reach rather than answering it, as science does with supernatural causes."
   ],
   [
    "Procedure-to-reality slide",
    "the error of treating a rule about how to investigate (method) as if it established a fact about what exists (metaphysics)."
   ]
  ],
  "quiz": [
   {
    "q": "Methodological naturalism asserts that the supernatural does not exist.",
    "opts": [
     "True",
     "False"
    ],
    "ans": 1,
    "ex": "False. <b>Methodological naturalism</b> only restricts inquiry to testable natural causes; it brackets the question of the supernatural rather than denying it. The denial belongs to <b>philosophical naturalism</b>."
   },
   {
    "q": "Which position could, without contradiction, be held by a religious believer who does serious scientific work?",
    "opts": [
     "Philosophical naturalism",
     "Methodological naturalism",
     "Neither, because all naturalism denies God",
     "Both equally"
    ],
    "ans": 1,
    "ex": "<b>Methodological naturalism</b> is a method that says nothing about a researcher&rsquo;s private metaphysics, so a believer can adopt it. <b>Philosophical naturalism</b> would contradict her theism."
   },
   {
    "q": "A debater argues: “Science only ever finds natural causes, so the supernatural cannot exist.” What is the flaw?",
    "opts": [
     "It treats a method as if it proved a claim about reality",
     "It misstates what scientists actually find",
     "It assumes the supernatural without evidence",
     "There is no flaw; the inference is valid"
    ],
    "ans": 0,
 ...
 "L2:5.1": {
  ...
  "terms": [
   [
    "Contractarianism",
    "The view that moral rules are justified as the terms rational, self-interested agents would agree to for their mutual benefit."
   ],
   [
    "Moral realism",
    "The position that at least some moral claims are objectively true, holding independently of any individual&rsquo;s or culture&rsquo;s opinion."
   ],
   [
    "Genetic fallacy",
    "The error of judging whether a claim is true or justified by appealing to its origin rather than to its actual merits."
   ],
   [
    "Euthyphro dilemma",
    "Plato&rsquo;s challenge asking whether something is good because God commands it, or whether God commands it because it is already good."
   ]
  ],
  "quiz": [
   {
    "q": "An evolutionary account explains why humans feel empathy and a sense of fairness. Does this by itself establish that any particular act is morally right?",
    "opts": [
     "True",
     "False"
    ],
    "ans": 1,
    "ex": "Explaining the origin of a moral feeling is not the same as justifying a moral claim. Treating origin as proof of correctness is the <b>genetic fallacy</b>; grounding requires a separate ethical theory."
   },
   {
    "q": "Which view holds that moral rules are best understood as the terms rational agents would agree to for mutual benefit?",
    "opts": [
     "Moral realism",
     "Contractarianism",
     "Divine command theory"
    ...
    "ans": 1,
    "ex": "<b>Contractarianism</b> grounds morality in agreements rational agents would accept, whereas <b>moral realism</b> holds that some moral facts are true independently of any such agreement."
   },
   {
    "q": "The Euthyphro dilemma poses a problem only for secular ethics, not for theistic accounts of morality.",
    "opts": [
     "True",
     "False"
    ],
 ...
 "L2:5.2": {
  ...
  "terms": [
   [
    "Consequentialism",
    "The view that the rightness of an action depends entirely on its outcomes, so the best act is the one producing the most good overall."
   ],
   [
    "Deontology",
    "The view that certain actions are right or wrong in themselves because of the duties and rules they honor or violate, regardless of their consequences."
   ],
   [
    "Virtue ethics",
    "The view that ethics centers on character rather than discrete acts, asking what a person possessing virtues such as honesty and courage would do."
   ],
   [
    "Utilitarianism",
    "The most common form of consequentialism, which defines the good outcome as the greatest balance of well-being across everyone affected."
   ]
  ],
  "quiz": [
   {
    "q": "Which framework judges an action primarily by the goodness of its results rather than by the act itself?",
    "opts": [
     "Deontology",
     "Consequentialism",
     "Virtue ethics"
    ...
    "ans": 1,
    "ex": "<b>Consequentialism</b> locates rightness in outcomes; deontology judges the act by duty, and virtue ethics judges the character of the agent."
   },
   {
    "q": "True or False: A religious believer cannot consistently hold any of these three frameworks, since each is built to exclude God.",
    "opts": [
     "True",
     "False"
    ],
 ...
 "L2:5.3": {
  ...
  "terms": [
   [
    "Cosmic purpose",
    "The idea that the universe as a whole was made for a goal or assigned a meaning from outside itself."
   ],
   [
    "Conferred meaning",
    "Value or significance that arises because conscious beings care about, choose, and commit to something, rather than being built into reality in advance."
   ],
   [
    "Subjective engagement",
    "A person&rsquo;s genuine caring about and investment in an activity, often paired with the activity itself being worthwhile to give a life meaning."
   ],
   [
    "Permanence objection",
    "The claim that meaning does not really count unless it lasts forever, which a secular account must answer rather than concede."
   ]
  ],
  "quiz": [
   {
    "q": "The lesson argues that &ldquo;the universe has no built-in purpose&rdquo; and &ldquo;my life has no value&rdquo; are the same claim.",
    "opts": [
     "True",
     "False"
    ],
    "ans": 1,
    "ex": "These are two separate claims. The lesson&rsquo;s first move is to keep <b>cosmic purpose</b> apart from the value of a particular life; treating them as one is the slide a debater should name out loud."
   },
   {
    "q": "On the secular view sketched here, where does a friendship&rsquo;s value come from?",
    "opts": [
     "A purpose stamped into the universe before anyone existed",
     "The caring and commitment of the people in the relationship",
     "Its guarantee of lasting forever"
    ],
    "ans": 1,
    "ex": "The view holds that value is relational and <b>conferred</b> by beings who care and commit, not discovered as a feature pre-built into reality."
   },
   {
    "q": "How does the lesson say a secularist should treat the theist&rsquo;s worry that conferred meaning is &ldquo;just invented&rdquo;?",
    "opts": [
     "Dismiss it, since the universe&rsquo;s indifference already settles the matter",
     "Answer it directly, because it is a real objection worth meeting",
     "Concede that without a god nothing can matter at all"
    ],
    "ans": 1,
 ...
 "L3:1.1": {
  ...
  "terms": [
   [
    "Prior probability",
    "The degree of belief assigned to a hypothesis before considering a specific piece of evidence, often grounded in simplicity or background knowledge."
   ],
   [
    "Likelihood",
    "The probability that the observed evidence would occur given that a particular hypothesis is true, compared across competing hypotheses."
   ],
   [
    "Posterior probability",
    "The revised degree of belief in a hypothesis after combining the prior with the likelihood of the new evidence via Bayes' theorem."
   ],
   [
    "Bayes' theorem",
    "The rule that mathematically combines a prior probability and a likelihood to produce a posterior probability, formalizing how beliefs should update on evidence."
   ]
  ],
  "quiz": [
   {
    "q": "In a Bayesian analysis, what does the 'likelihood' of a piece of evidence measure?",
    "opts": [
     "How plausible the hypothesis was before any evidence was considered",
     "How expected the evidence is assuming the hypothesis is true",
     "The final degree of belief after updating",
     "Whether the evidence logically proves the hypothesis"
    ],
    "ans": 1,
    "ex": "The likelihood asks how probable the evidence would be <b>if the hypothesis were true</b>, typically compared against rival hypotheses. Plausibility before evidence is the prior; the updated belief is the posterior."
   },
   {
    "q": "A theist and an atheist run the same Bayesian calculation on fine-tuning yet reach opposite conclusions. According to the lesson, where does their disagreement most likely lie?",
    "opts": [
     "In the arithmetic of Bayes' theorem",
     "In the priors and likelihoods each assigns",
     "In whether evidence exists at all"
    ],
    "ans": 1,
    "ex": "The math itself is rarely the issue. Disagreement almost always lives in the <b>priors and likelihoods</b> each side assigns, which is why identical calculations can yield opposite posteriors."
   },
   {
    "q": "How does the Bayesian approach reframe the traditional theism debate?",
    "opts": [
     "It seeks to prove or disprove God with logical certainty",
     "It treats observations as evidence that shifts probability rather than as decisive proof",
     "It declares the question of God meaningless"
    ],
    "ans": 1,
 ...
 "L3:1.2": {
  ...
  "terms": [
   [
    "Fine-tuning",
    "The observation that several fundamental physical constants lie within narrow ranges that appear necessary for the existence of complex structures and life."
   ],
   [
    "Normalizability",
    "The requirement that a probability distribution sum or integrate to one, which fails for a uniform distribution spread over an infinite or unbounded range of possible constant values."
   ],
   [
    "Multiverse",
    "The hypothesis that many universes exist with differing physical constants, so that at least one life-permitting universe is statistically unremarkable."
   ],
   [
    "Observer selection effect",
    "The principle that our observations are constrained by the conditions necessary for observers to exist, so we should expect to find ourselves in a hospitable universe regardless of how rare such universes are."
   ]
  ],
  "quiz": [
   {
    "q": "Why does the normalizability problem threaten the claim that a constant&rsquo;s value is &ldquo;fantastically improbable&rdquo;?",
    "opts": [
     "Because the constants have been measured imprecisely",
     "Because a uniform distribution over an infinite range cannot be normalized to sum to one, leaving &ldquo;improbable&rdquo; undefined",
     "Because probability cannot apply to physical objects",
     "Because the multiverse makes all values equally likely"
    ],
    "ans": 1,
    "ex": "A probability distribution must integrate to one. Spreading probability uniformly over an <b>infinite or unbounded range</b> cannot be normalized, so the improbability claim has no well-defined meaning without first justifying a measure."
   },
   {
    "q": "What is the core of the &ldquo;this universe&rdquo; objection to the multiverse reply?",
    "opts": [
     "The multiverse cannot be observed directly",
     "Even granting many universes, the fine-tuning of our particular universe still seems to call for explanation",
     "Multiverse theories violate conservation of energy",
     "Other universes would necessarily be hostile to life"
    ],
    "ans": 1,
    "ex": "The objection presses that postulating many universes may explain why <i>some</i> universe is hospitable, but the fine-tuning of <b>this particular universe</b> appears to remain unexplained."
   },
   {
    "q": "How does the observer selection effect respond to the &ldquo;this universe&rdquo; objection?",
    "opts": [
     "It denies that the constants are fine-tuned at all",
     "It argues that observers can only arise in hospitable universes, so conditioning on our own existence is appropriate",
     "It proves the multiverse is false",
     "It shows the constants could take any value"
    ],
    "ans": 1,
 ...
 "L3:1.3": {
  ...
  "terms": [
   [
    ...
    "A belief that is rational to hold immediately, without being inferred from or supported by other beliefs or arguments."
   ],
   [
    "Evidentialism",
    "The view that a belief is rational only if it is held in proportion to the propositional evidence or argument supporting it."
   ],
   [
    "Warrant",
   ...
   [
    ...
    "The challenge that if belief in God can count as properly basic, then so could any absurd belief, since the category seems to lack a principled gatekeeper."
   ]
  ],
  "quiz": [
   {
    "q": "What does it mean to call belief in God “properly basic” on Plantinga’s view?",
    "opts": [
     "That it is proven by a rigorous deductive argument",
     "That it can be rationally held immediately, without being inferred from other beliefs",
     "That it is the most fundamental claim in any religion",
   ...
   },
   {
    ...
    "opts": [
     "That God is too abstract to be experienced directly",
     "That theism has no historical evidence",
     "That if God-belief can be properly basic, absurd beliefs could claim the same status",
     "That Plantinga contradicts evidentialism"
    ],
    "ans": 2,
    "ex": "The objection presses that without a principled gatekeeper, the properly-basic category could <b>license any absurd belief</b>, such as belief in the Great Pumpkin."
   },
   {
    "q": "How does Plantinga respond to the Great Pumpkin objection?",
    "opts": [
     "He concedes that all basic beliefs are equally valid",
     "He argues criteria for proper basicality are built from clear examples and can exclude ungrounded beliefs",
     "He abandons the idea of properly basic belief",
     "He claims the objection proves God exists"
    ],
    "ans": 1,
 ...
 "L3:1.4": {
  ...
  "terms": [
   [
    "Divine hiddenness",
    "The phenomenon, treated as a problem for theism, in which sincere and open inquirers fail to find evidence or experience sufficient to believe that God exists."
   ],
   [
    "Non-resistant nonbelief",
    "Failure to believe in God on the part of a person who is not resisting or refusing such belief and would welcome a relationship with God if convinced."
   ],
   [
    "Perfect love (divine)",
    "The attribute, central to Schellenberg's argument, by which a maximally loving God is always open to and seeks personal relationship with every being capable of one."
   ],
   [
    "Soul-making / free-response defense",
    "A family of theistic replies holding that hiddenness preserves the freedom and moral significance of faith, which a coercive divine self-disclosure would undermine."
   ]
  ],
  "quiz": [
   {
    "q": "What specific kind of unbelief does Schellenberg's argument target?",
    "opts": [
     "The willful unbelief of those who reject God out of pride",
     "Non-resistant nonbelief by sincere people open to a relationship",
     "The unbelief of those who have never heard of God",
   ...
   },
   {
    ...
    "opts": [
     "Because a loving God would punish unbelievers",
     "Because love requires God to prove every doctrine",
     "Because a relationship requires belief that the other party exists, and a loving God would ensure such belief is available",
     "Because suffering shows God is not all-powerful"
    ],
    "ans": 2,
    "ex": "A personal relationship presupposes <b>belief that the other exists</b>; if God is always open to relationship, no non-resistant person should be left without that belief. That is the conditional the whole argument turns on."
   },
   {
    "q": "Which is a standard theistic response to the hiddenness argument?",
    "opts": [
     "Hiddenness preserves the freedom and moral weight of faith, which coerced belief would destroy",
     "Sincere seekers do not actually exist",
     "Divine love has nothing to do with relationship",
     "The argument is logically invalid in form"
    ],
    "ans": 0,
 ...
 "L3:1.5": {
  ...
  "terms": [
   [
    "Miracle (Humean sense)",
    "An event that constitutes a violation of a law of nature, brought about by a deity or supernatural agent rather than a mere rare natural occurrence."
   ],
   [
    "Balance of probabilities",
    "Hume's method of weighing the antecedent improbability of a law being broken against the probability that the testimony reporting it is false."
   ],
   [
    "Hume's maxim",
    "The principle that no testimony is sufficient to establish a miracle unless its falsehood would be more improbable than the miraculous event it asserts."
   ],
   [
    "Prior probability",
    "In Bayesian terms, the credence assigned to a claim before the testimony is weighed; for an alleged miracle this prior is set very low by uniform experience."
   ]
  ],
  "quiz": [
   {
    ...
    "ans": 1,
    "ex": "Hume does not claim miracles are impossible. His point is evidential: a <b>miracle violates a law of nature</b>, and that law is backed by uniform experience, so the prior probability against the event is as low as evidence can make it."
   },
   {
    "q": "Which statement best captures Hume's maxim about testimony?",
    "opts": [
     "Credit a miracle only if many people report it",
     "Reject all testimony about unusual events",
     "Credit the testimony only if its being false would be more miraculous than the event it reports",
     "Testimony always outweighs the laws of nature"
    ],
    "ans": 2,
    "ex": "Hume's maxim weighs two improbabilities: only when the witness <b>being wrong is harder to believe</b> than the law itself failing should we accept the miracle claim."
   },
   {
    "q": "What is the strongest, most defensible secular conclusion from Hume's argument?",
    "opts": [
     "No miracle has ever occurred or could occur",
     "God definitely does not exist",
     "The evidential standard for rationally believing a specific miracle is rarely met by typical testimony",
     "Personal religious experience is meaningless"
    ],
    "ans": 2,
 ...
 "L3:2.1": {
  ...
  "terms": [
   [
    ...
    "A proposed cognitive bias toward interpreting ambiguous events as caused by intentional agents, because over-detecting threats was evolutionarily cheaper than missing a real one."
   ],
   [
    "Theory of mind",
    "The everyday human capacity to attribute mental states such as beliefs, desires, and intentions to others, which can be extended to imagined invisible or disembodied agents."
   ],
   [
    "By-product theory",
    "The view that religious belief is not a direct biological adaptation but an incidental side effect of cognitive systems that evolved for other purposes."
   ],
   [
    "Minimally counterintuitive concept",
    "An idea that is mostly consistent with ordinary expectations but violates one category in a striking way, making it especially easy to remember and transmit."
   ]
  ],
  "quiz": [
   {
    "q": "According to by-product theory, religious belief is best described as:",
    "opts": [
     "A dedicated evolutionary adaptation selected specifically to produce faith",
     "A side effect of cognitive systems that evolved for other survival tasks",
     "A purely cultural invention with no basis in human cognition",
     "Direct perceptual evidence that supernatural agents exist"
    ],
    "ans": 1,
    "ex": "By-product theory holds that god-concepts arise as an <b>incidental side effect</b> of mental systems (like agency detection and theory of mind) selected for other purposes, not as a trait selected for belief itself."
   },
   {
    "q": "Why is the Hyperactive Agency Detection Device described as biased toward false alarms?",
    "opts": [
     "Because mistakenly sensing an agent is usually far less costly than missing a real threat",
     "Because the brain cannot perceive ambiguous stimuli at all",
     "Because detecting agents requires conscious deliberation",
     "Because it only activates in religious contexts"
    ],
    "ans": 0,
    "ex": "The asymmetry of costs drives the bias: a <b>false positive</b> (sensing a predator that isn't there) wastes little energy, while a false negative (missing a real predator) can be fatal, so the system errs toward over-detection."
   },
   {
    "q": "How does the cognitive science of religion bear on the truth of theistic claims?",
    "opts": [
     "It proves God does not exist by explaining belief",
     "It proves God exists by showing belief is universal",
     "Explaining why a belief arises is logically separate from whether the belief is true",
     "It shows belief is too irrational to discuss"
    ],
    "ans": 2,
 ...
 "L3:2.2": {
  ...
  "terms": [
   [
    ...
    "The hypothesis that awareness of one’s own death creates a latent dread that cultural and religious worldviews promising immortality or lasting meaning serve to buffer."
   ],
   [
    "Social cohesion (group-functional account)",
    "The view that religion persists because shared ritual, costly commitment signals, and morally concerned gods foster trust and cooperation among otherwise unrelated individuals."
   ],
   [
    "Adaptation vs. byproduct",
    "The central dispute over whether religious cognition was directly selected for its benefits (adaptation) or arose as an incidental side effect of mental systems evolved for other purposes (byproduct, or spandrel)."
   ],
   [
    "Functional account",
    "Any explanation that accounts for a trait by what it does for the organism or group, which describes religion’s effects without thereby settling whether its claims are true."
   ]
  ],
  "quiz": [
   {
    "q": "What is the central claim of terror-management theory as applied to religion?",
    "opts": [
     "Religion was invented by ruling elites to frighten the population into obedience",
     "Worldviews promising immortality or lasting meaning buffer the anxiety produced by awareness of death",
     "Fear of natural disasters is the sole origin of all religious ritual",
   ...
   },
   {
    ...
    "opts": [
     "The studies were never actually conducted",
     "A belief’s usefulness is logically independent of its truth, so showing a function neither confirms nor refutes the claims",
     "Cooperation has nothing to do with religion",
   ...
   },
   {
    ...
    "opts": [
     "An adaptation was directly selected for its benefits, whereas a byproduct rides on cognitive machinery that evolved for other purposes",
     "An adaptation is always true and a byproduct is always false",
     "Adaptations occur only in humans while byproducts occur in all animals",
 ...
 "L3:2.3": {
  ...
  "terms": [
   [
    "Deconversion",
    "The gradual psychological and social process by which a person abandons a previously held religious faith, typically driven by accumulated doubts rather than a single decisive event."
   ],
   [
    "Street Epistemology",
    "A conversational method that uses calibrated, non-adversarial questions to help an interlocutor examine the reliability of the methods they used to arrive at a belief, rather than disputing the belief directly."
   ],
   [
    "Belief revision",
    "The cognitive process of updating one's commitments in light of new information, characterized by a tendency to protect core beliefs while conceding peripheral ones first."
   ],
   [
    "Backfire effect",
    "A proposed phenomenon in which directly contradicting a strongly held belief causes a person to defend it more firmly rather than reconsider it, often because the belief is tied to identity."
   ]
  ],
  "quiz": [
   {
    "q": "According to research on deconversion, how does loss of religious faith most commonly occur?",
    "opts": [
     "As a sudden, single decisive moment of insight",
     "As a gradual accumulation of unresolved tensions that eventually crosses a threshold",
     "Almost always as a direct result of losing one formal debate",
     "Through inheritance, with no role for personal experience"
    ],
    "ans": 1,
    "ex": "Deconversion is typically a <b>gradual accumulation</b> of intellectual, moral, and social tensions that build until they cross a threshold, not a single thunderbolt event."
   },
   {
    "q": "What is the central technique of Street Epistemology?",
    "opts": [
     "Presenting overwhelming evidence against a specific religious claim",
     "Asking calibrated questions about the reliability of the methods used to form a belief",
     "Publicly debating a believer to expose contradictions",
     "Quoting authoritative philosophers to settle the question"
    ],
    "ans": 1,
    "ex": "Street Epistemology targets the <b>method</b> of belief formation through non-confrontational questions, rather than attacking the conclusion directly."
   },
   {
    "q": "Why does the lesson argue that a rhetorical victory can forfeit a changed mind?",
    "opts": [
     "Because changing minds is impossible in any debate setting",
     "Because feeling cornered can trigger identity-protective entrenchment, sometimes called the backfire effect",
     "Because audiences never remember who won a debate",
     "Because believers lack the capacity to revise their views"
    ],
    "ans": 1,
 ...
 "L3:3.1": {
  "read": [
   "When Nietzsche announced that God is dead, he was not gloating, nor was he making a metaphysical claim about whether a deity exists. He was diagnosing a cultural fact: the Christian-Platonic framework that had grounded European morality, meaning, and truth for two millennia had lost its hold on the educated conscience. Science, historical criticism, and the Enlightenment had hollowed out the foundations, even as most people continued to live as though those foundations remained intact. Nietzsche took this seriously as a crisis. If the highest values devalue themselves, on what does morality now stand? His question is sharper than the believer's confidence and harder than the atheist's complacency, because it refuses the comforts of both.",
   "The danger Nietzsche named was nihilism: the condition in which, the inherited source of value having collapsed, nothing seems worth willing and the will to truth turns against life itself. He distinguished a passive nihilism that sinks into exhaustion from an active one that clears the ground. His proposed overcoming was not a return to old certainties but a revaluation of values, in which the human being becomes the creator of meaning rather than its passive recipient. Concepts like the will to power, the eternal recurrence as a test of affirmation, and the Übermensch sketch a life that says yes to existence without metaphysical guarantees. Whether such self-grounded meaning can bear real weight is precisely the open wound he leaves us.",
   "For a debate-first school, Nietzsche cuts in two directions, and an honest expert holds both. Against the believer, he warns that borrowed Christian morality cannot survive the death of its source unacknowledged; secular ethics must do the harder work of justifying itself rather than coasting on a faith it has abandoned. Yet his challenge equally exposes a debt many secularists deny owing. The theist can press the strongest counter: if value is something we create rather than discover, what stops the strong from creating values that simply serve them? Nietzsche offers no neutral arbiter, and the charitable critic asks whether his affirmation is a genuine answer to nihilism or a courageous wager dressed as one. The examined life, on his terms, means refusing easy resolution on either side."
  ],
  "terms": [
   [
    "Death of God",
    "Nietzsche's claim that the Christian and metaphysical foundations once grounding European morality and meaning have lost their cultural authority, not a literal assertion about a deity's existence."
   ],
   [
    "Nihilism",
    "The condition in which, the highest values having devalued themselves, existence appears to lack any objective meaning, purpose, or worth worth willing."
   ],
   [
    "Revaluation of values",
    "Nietzsche's proposed response to nihilism, in which inherited moral valuations are critically reassessed and the human being becomes the creator rather than mere inheritor of meaning."
   ],
   [
    "Eternal recurrence",
    "The thought experiment that one's life will repeat identically forever, used as a test of whether a person can wholly affirm their existence rather than resent it."
   ]
  ],
  "quiz": [
   {
    "q": "When Nietzsche says “God is dead,” he is primarily making what kind of claim?",
    "opts": [
     "A metaphysical proof that no deity exists",
     "A cultural diagnosis that the framework grounding Western morality and meaning has lost its authority",
     "A prediction that organized religion will soon vanish entirely",
     "A personal confession of his own loss of faith"
    ],
    "ans": 1,
    "ex": "Nietzsche's statement is a <b>cultural diagnosis</b>, not a metaphysical proof. He observes that the shared foundation underwriting morality and meaning has collapsed in the educated conscience, even while many continue to live as if it still held."
   },
   {
    "q": "What did Nietzsche see as the central danger following the collapse of inherited values?",
    "opts": [
     "A return to strict religious orthodoxy",
     "Nihilism, the sense that nothing remains worth willing",
     "The triumph of scientific certainty over all doubt",
     "Universal agreement on a new secular morality"
    ],
    "ans": 1,
    "ex": "The danger Nietzsche named was <b>nihilism</b>: with the source of the highest values gone, existence can appear to lack any worth, and the will to truth can turn against life itself."
   },
   {
    "q": "Which objection would a theist most pointedly raise against Nietzsche's revaluation of values?",
    "opts": [
     "It relies too heavily on biblical authority",
     "If humans create rather than discover values, nothing prevents the strong from inventing values that merely serve themselves",
     "It proves that God must exist after all",
     "It is identical to ordinary Enlightenment atheism"
    ],
    "ans": 1,
 ...
 "L3:3.2": {
  ...
  "terms": [
   [
    "The absurd",
    "The conflict, in Camus, between the human demand for meaning and clarity and a universe that offers no inherent answer."
   ],
   [
    "Revolt (Camus)",
    "Living in full awareness of the absurd without escaping it through suicide or religious faith, keeping the tension consciously open."
   ],
   [
    "Existence precedes essence",
    "Sartre’s claim that humans have no predetermined nature and define who they are through their own choices."
   ],
   [
    "Bad faith",
    "Sartre’s term for the self-deception of denying one’s freedom by treating chosen actions as if they were unavoidable."
   ]
  ],
  "quiz": [
   {
    ...
    "opts": [
     "The belief that life is a meaningless joke to be mocked",
     "The clash between our need for meaning and an indifferent, silent universe",
     "The proof that God cannot exist",
     "The conclusion that suicide is the rational response to existence"
    ],
    "ans": 1,
    "ex": "For Camus the absurd is a <b>relation</b>, not a doctrine: it arises from the collision between human longing for clarity and a universe that returns no answer. He explicitly rejects suicide and treats theism charitably rather than disproving it."
   },
   {
    "q": "When Sartre says “existence precedes essence,” he means that:",
    "opts": [
     "God designs each person’s purpose before birth",
     "Human beings have no fixed nature and must define themselves through choice",
     "Physical existence is more real than abstract ideas"
    ],
    "ans": 1,
    "ex": "Sartre inverts the classical order in which a thing’s purpose (essence) is fixed first. For humans, <b>existence comes first</b> and there is no preset nature, so we author ourselves through our choices and bear full responsibility for them."
   },
   {
    "q": "Which charge does the theist most directly raise against Camus and Sartre?",
    "opts": [
     "Without a transcendent source, their talk of value and obligation lacks any anchor",
     "Their philosophy is too optimistic about human nature",
     "They secretly believe in an afterlife"
    ],
    "ans": 0,
 ...
 "L3:3.3": {
  ...
  "terms": [
   [
    "Constructed meaning",
    "The view that purpose is built through our commitments, relationships, and projects rather than discovered as a pre-existing fact about the universe."
   ],
   [
    "Secular Stoicism",
    "A modern adaptation of Stoic ethics that keeps the focus on what we can control and our considered judgments while setting aside the ancient Stoic belief in a divinely ordered cosmos."
   ],
   [
    "Secular Buddhism",
    "An approach that treats Buddhist practices like mindfulness and the easing of craving as psychological methods for reducing suffering, without commitment to supernatural claims such as literal rebirth."
   ],
   [
    "Borrowed-capital objection",
    "The theistic argument that secular ethical practices remain coherent only because they inherit assumptions originally grounded in the religious frameworks they have abandoned."
   ]
  ],
  "quiz": [
   {
    "q": "In the secular framing presented here, meaning is best described as something that is:",
    "opts": [
     "Discovered as a fixed fact written into the cosmos",
     "Constructed through ongoing commitments and practices",
     "Granted only by a divine author",
     "Impossible to have without religion"
    ],
    "ans": 1,
    "ex": "The lesson contrasts meaning <b>discovered like a fossil</b> with meaning <b>constructed like a relationship</b>, built through commitments and repeated practice rather than received from outside."
   },
   {
    "q": "What distinguishes secular Stoicism from its ancient predecessor?",
    "opts": [
     "It rejects the idea that we should focus on what we control",
     "It keeps the focus on judgment and control while setting aside the divinely ordered cosmos",
     "It adds a belief in literal rebirth",
   ...
   },
   {
    ...
    "opts": [
     "Deny that the practices have any religious history",
     "Concede the practices cannot work without religion",
     "Test whether the practices survive translation into a purpose-free universe",
 ...
 "L3:4.1": {
  ...
  "terms": [
   [
    "Moral realism",
    "The view that there are objective moral facts or truths that hold independently of any individual's or culture's attitudes toward them."
   ],
   [
    "Anti-realism",
    "The denial that mind-independent moral facts exist, treating moral claims as expressions, constructions, or systematic errors rather than descriptions of an objective moral reality."
   ],
   [
    "Error theory",
    "J. L. Mackie's position that moral claims genuinely assert objective values but are uniformly false because no such values exist, making everyday moral talk a sincere but mistaken enterprise."
   ],
   [
    "Quasi-realism",
    "Simon Blackburn's project of showing how an expressivist, who treats moral statements as voicing attitudes, can legitimately recover talk of moral truth, knowledge, and objectivity without committing to mind-independent moral facts."
   ]
  ],
  "quiz": [
   {
    "q": "What distinguishes error theory from quasi-realism, given that both deny mind-independent moral facts?",
    "opts": [
     "Error theory says moral claims are false; quasi-realism says they express attitudes yet can still earn talk of truth",
     "Error theory affirms moral facts while quasi-realism denies them",
     "They are two names for the same position",
     "Quasi-realism claims moral claims are all false while error theory says they are all true"
    ],
    "ans": 0,
    "ex": "Both are anti-realist, but they diverge on what moral language does. Error theory holds that moral claims <b>aim at truth and systematically fail</b> because the objective values they presuppose do not exist. Quasi-realism holds that moral claims <b>express attitudes</b> rather than describe facts, then reconstructs truth-talk from within that expressivist framework."
   },
   {
    ...
    "ans": 1,
    "ex": "The charitable move identifies the <b>hidden premise</b>: that objective morality requires a divine source. A naturalist realist locates moral facts in features of persons and their lives, and a quasi-realist recovers objectivity without spooky objects, so neither needs to <b>concede the theist's premise</b> to answer the worry."
   },
   {
    "q": "On moral realism, what does it mean to call a moral fact 'objective'?",
    "opts": [
     "That a majority of people happen to agree about it",
     "That it was commanded by a recognized authority",
     "That it holds independently of any individual's or culture's attitudes toward it",
     "That it produces strong feelings of approval or disgust"
    ],
    "ans": 2,
 ...
 "L3:4.2": {
  ...
  "terms": [
   [
    "Consequentialism",
    "The view that the rightness of an act depends entirely on its outcomes, typically the total balance of welfare it produces."
   ],
   [
    "Deontology",
    "The view that certain acts are obligatory or forbidden in themselves, independent of their consequences, because of duties and rights persons hold."
   ],
   [
    "Virtue ethics",
    "The view that ethics centers on the character traits of a good agent, asking what a person of practical wisdom would do rather than which rule or outcome decides."
   ],
   [
    "Euthyphro problem",
  ...
  "quiz": [
   {
    ...
    "ans": 0,
    "ex": "The case strains <b>consequentialism</b> because maximizing aggregate welfare can appear to license using one innocent person as a mere means to save five, which clashes with most people's considered judgment."
   },
   {
    ...
    "ans": 1,
    "ex": "Strict deontology's strength is protecting persons from being overridden by outcomes, but its <b>rigidity</b> means an exceptionless duty (never lie) can require an action that strikes most people as plainly bad."
   },
   {
    "q": "The Euthyphro problem presses on a theistic ethics by asking which question?",
    "opts": [
     "Whether God exists at all",
     "Whether morality produces good consequences",
     "Whether something is good because God commands it, or commanded because it is good",
 ...
 "L3:4.3": {
  ...
  "terms": [
   [
    "Public reason",
    "The principle that laws backed by state coercion should be justifiable by arguments and evidence that citizens can accept regardless of their particular religious or comprehensive worldview."
   ],
   [
    "Principlism",
   ...
   [
    "Moral status",
    "The question of which beings count morally and how much, often argued from inspectable features such as sentience, self-awareness, or the capacity for interests rather than from theological premises."
   ],
   [
    "Overlapping consensus",
    "A situation in which people holding different and even conflicting deeper worldviews nonetheless converge on the same practical norm for their own distinct reasons."
   ]
  ],
  "quiz": [
   {
    "q": "Why does public bioethics typically avoid grounding policy in a specific religious text?",
    "opts": [
     "Because religious arguments are always false",
     "Because coercive policy in a plural society needs justifications that people of differing worldviews can weigh and contest",
     "Because believers are barred from ethics boards",
     "Because secular ethics is simpler to teach"
    ],
    "ans": 1,
    "ex": "The aim is <b>shared deliberation under coercion</b>: a binding policy should rest on reasons all affected citizens can in principle assess, not on a premise only some accept. This says nothing about whether religious claims are true."
   },
   {
    "q": "Which four principles make up the standard principlist framework?",
    "opts": [
   ...
   },
   {
    ...
    "opts": [
     "That ethics boards meet too infrequently",
     "That without transcendent grounding, concepts like dignity may lack a firm anchor",
     "That autonomy is impossible to define",
     "That science has disproven morality"
    ],
    "ans": 1,
 ...
 "L3:5.1": {
  "read": [
   "A serious thinker eventually asks why the same argument that lands cleanly at a dinner table can collapse in a structured contest. The answer is that competitive debate is not a free exchange of views but a game with rules, clocks, and burdens of proof, and each format encodes a different theory of what good public reason looks like. <b>British Parliamentary</b> seats four two-person teams who must extend, not merely repeat, the case; <b>Lincoln-Douglas</b> stages a one-on-one clash over a value premise rather than a policy; <b>Oregon-style cross-examination</b> (CX) pairs long constructive speeches with direct interrogation. Learning the format is learning what counts as a winning move.",
   "The unifying skill beneath every format is the discipline of tracking arguments rather than rhetoric. Debaters do this through <b>flowing</b>: a columnar shorthand in which each claim is written down and answered claim-by-claim, so that an assertion left unrebutted is treated as conceded for the round. This matters philosophically because it externalizes the burden of response. A believer arguing for a moral realist premise in Lincoln-Douglas, or a secularist contesting it, both win or lose not on eloquence but on whether the specific link in the opponent's chain was answered. The flow turns a conversation into an auditable ledger, and it rewards precision over volume, charity over caricature, and structure over heat.",
   "For our purposes the debate implication is sharpening rather than triumph. Formats teach that a strong case anticipates the strongest reply, which is exactly the charitable posture we owe a thoughtful theist. A drop on the flow is the formalized version of a real intellectual failure: ignoring the part of an argument you cannot easily answer. When you internalize British Parliamentary extension, Lincoln-Douglas value-clash, and CX cross-examination, you stop treating disagreement as a performance and start treating it as a shared search constrained by rules both sides accept. The aim is not to defeat an opponent on a clock but to hold your own reasoning to the standard a fair judge would apply."
  ],
  "terms": [
   [
    "British Parliamentary (BP)",
    "A four-team format in which two teams defend and two oppose a motion, with later teams required to extend the debate by adding new material rather than restating their side."
   ],
   [
    "Lincoln-Douglas",
    "A one-on-one format that contests a value resolution, requiring each debater to defend a value premise and a criterion for weighing it rather than a concrete policy."
   ],
   [
    "Oregon-style cross-examination (CX)",
    "A two-on-two policy format alternating timed constructive speeches with periods of direct cross-examination by the opposing debater."
   ],
   [
    "Flowing",
    "The note-taking method of recording arguments in parallel columns so each claim is tracked across speeches, with any unanswered claim counting as conceded."
   ]
  ],
  "quiz": [
   {
    "q": "What distinguishes the role of later teams in British Parliamentary debate?",
    "opts": [
     "They must extend the case with new material, not merely repeat their side",
     "They are exempt from defending the motion",
     "They judge the earlier teams",
     "They speak first to set the framing"
    ],
    "ans": 0,
    "ex": "BP seats four teams per side-pairing, and the later teams must <b>extend</b> the debate by contributing new arguments or analysis rather than restating what their opening teammates already said."
   },
   {
    "q": "A Lincoln-Douglas resolution is primarily a contest over what?",
    "opts": [
     "A specific government policy and its budget",
     "A value premise and the criterion for weighing it",
     "Which debater speaks more quickly",
     "The factual accuracy of statistics"
    ],
    "ans": 1,
    "ex": "Unlike policy formats, Lincoln-Douglas centers on a <b>value</b> resolution, so each side defends a value and a criterion for evaluating which value should prevail in the round."
   },
   {
    "q": "On the flow, what happens to a specific argument the opponent never answers?",
    "opts": [
     "It is discarded as irrelevant",
     "It is treated as conceded for that round",
     "It is automatically rebutted by the judge",
     "It must be repeated to count"
    ],
    "ans": 1,
 ...
 "L3:5.2": {
  ...
  "terms": [
   ...
   [
    "Weighing",
    "The explicit comparison of surviving arguments by their strength, scope, and probability so that a judge can rank them rather than merely tally how many were raised."
   ],
   [
    "Clash",
    "Direct engagement with the strongest version of an opponent’s actual argument, as opposed to restating one’s own case or rebutting a weaker substitute."
   ],
   [
    "Collapsing and extending",
    "Narrowing late in a debate onto the few lines you can win decisively (collapsing) and carrying conceded or unanswered points forward as established (extending)."
   ]
  ],
  "quiz": [
   {
    "q": "In advanced rebuttal, what most distinguishes weighing from simply listing objections?",
    "opts": [
     "Weighing requires more objections than the opponent raised",
     "Weighing compares the surviving arguments by strength and importance under a shared standard",
     "Weighing means restating your own case more forcefully",
   ...
   },
   {
    ...
    "opts": [
     "Because rebutting a weak or distorted version of theism settles nothing",
     "Because it guarantees the secular side will win",
     "Because judges penalize any criticism of religion",
     "Because theistic arguments cannot be answered directly"
    ],
    "ans": 0,
    "ex": "Clash requires meeting the <b>strongest</b> version of the opponent’s argument. Defeating a caricature proves nothing about the real position, so stating theism at full strength is what makes a rebuttal count."
   },
   {
    "q": "What does it mean to “collapse” in the final stage of a debate?",
    "opts": [
     "To abandon the debate entirely",
     "To raise as many new arguments as possible at the end",
     "To narrow onto the few lines you can win decisively and extend them as voters",
     "To concede that the opponent has won"
    ],
    "ans": 2,
 ...
 "L3:5.3": {
  ...
  "terms": [
   [
    "Steelmanning",
    "The practice of reconstructing an opposing argument in its strongest and most defensible form before attempting to refute it."
   ],
   [
    "Strawman",
    "A distorted or weakened version of an opponent's position that is easier to attack than the position actually held."
   ],
   [
    "Charitable interpretation",
    "Reading an argument as its most thoughtful proponent would state it, supplying reasonable missing premises and resolving ambiguity in the speaker's favor."
   ],
   [
    "Gish gallop",
    "A rhetorical tactic of overwhelming an opponent with many weak or unsupported claims faster than any can be individually addressed."
   ]
  ],
  "quiz": [
   {
    "q": "What is the defining feature of steelmanning, as opposed to merely being polite to an opponent?",
    "opts": [
     "Conceding the opponent's conclusion to avoid conflict",
     "Reconstructing the opponent's argument in its strongest defensible form before responding",
     "Restating the opponent's words verbatim without analysis",
     "Refusing to argue against positions you disagree with"
    ],
    "ans": 1,
    "ex": "Steelmanning is a discipline of <b>accuracy, not agreement</b>: you build the strongest version of the opposing argument before responding, which is why a refutation that beats the steelman is far more durable than one that beats a caricature."
   },
   {
    "q": "An apologist responds to a critique by rapidly listing twelve separate arguments for design, fine-tuning, morality, and miracles, demanding each be answered at once. Which tactic is this?",
    "opts": [
     "A steelman",
     "Charitable interpretation",
     "The Gish gallop"
    ...
    "ans": 2,
    "ex": "The <b>Gish gallop</b> wins by volume rather than strength, burying the responder under more weak claims than can be answered. The disciplined reply is to decline the race and engage the single strongest claim fully."
   },
   {
    "q": "Why does steelmanning strengthen a critic's position in public debate rather than weaken it?",
    "opts": [
     "It guarantees the opponent will concede the argument",
     "It removes the opponent's escape route of claiming they were misunderstood, and earns the audience's trust",
     "It proves theistic arguments are always false",
     "It allows the critic to avoid reading difficult material"
    ],
    "ans": 1,
 ...
 "L3:5.4": {
  "read": [
   "A debate that lands cleanly in a seminar room can dissolve into noise on a stage, in a comment thread, or before a crowd that arrived already decided. Why does the same argument behave so differently at scale? The honest answer is that public reason is not merely private reasoning amplified. As the audience grows, the channel narrows: nuance gets stripped, social identity activates, and listeners read tone and posture as much as content. The expert speaker treats this not as a corruption of reason but as its native habitat. The task is to carry a genuine argument intact through a medium that punishes complexity and rewards confidence, without trading the argument away for the applause.",
   "The working principle is that scale shifts your goal from winning the person in front of you to modeling good reasoning for everyone watching. Hostile audiences rarely change their minds mid-exchange; the persuadable parties are the quiet observers. This is where Street Epistemology earns its keep. Rather than attacking a believer's conclusion, you ask, with real curiosity, how they arrived at it and how confident they are that the method is reliable. A respectful question about justification does more public work than a clever rebuttal, because the crowd sees a thinker who is fair, not a combatant who is merely loud. Charity here is strategic and sincere at once: you grant your interlocutor their best case, then probe the reasoning that supports it.",
   "For debate, this reframes what victory means at scale. A technically flawless takedown that humiliates a thoughtful believer can lose the room, while a patient exchange that leaves the question genuinely open can win it. The expert prepares for the medium: short load-bearing claims, a single memorable thread, and pre-rehearsed responses to predictable hostility that stay calm rather than escalate. You concede what is true on the other side promptly, because visible fairness buys credibility that no rhetorical flourish can. The deepest skill is holding your composure when provoked, since a hostile audience is often testing temperament, not argument, and the watching majority scores you on both."
  ],
  "terms": [
   [
    "Public reason",
    "The practice of justifying claims through arguments accessible to a general audience rather than to specialists, where clarity and shared premises matter more than technical precision."
   ],
   [
    "Street Epistemology",
    "A conversational method that examines how a person reached a belief and how reliable that method is, rather than directly disputing the belief's content."
   ],
   [
    "Hostile audience",
    "A group predisposed against the speaker or position, where the realistic aim is to persuade undecided observers rather than to convert committed opponents."
   ],
   [
    "Steelmanning",
    "Stating an opponent's position in its strongest, most charitable form before responding, which builds credibility and ensures the rebuttal targets the real argument."
   ]
  ],
  "quiz": [
   {
    "q": "At scale, who is the realistic target of persuasion when facing a hostile audience?",
    "opts": [
     "The most vocal opponent in the room",
     "The quiet, undecided observers watching the exchange",
     "Yourself, by rehearsing your own conviction",
     "The event organizers"
    ],
    "ans": 1,
    "ex": "Committed opponents rarely shift mid-exchange. The <b>persuadable parties are the silent observers</b>, who judge you on fairness and composure as much as on content."
   },
   {
    "q": "What is the central move of Street Epistemology?",
    "opts": [
     "Refuting the believer's conclusion with stronger evidence",
     "Asking how the person reached the belief and how reliable that method is",
     "Demanding the believer define every term precisely",
     "Conceding the belief to keep the peace"
    ],
    "ans": 1,
    "ex": "Street Epistemology targets <b>method, not conclusion</b>: it asks how a belief was formed and how trustworthy that route is, modeling curiosity rather than combat."
   },
   {
    "q": "Why does a technically perfect takedown sometimes lose the room?",
    "opts": [
     "Audiences cannot follow rigorous arguments",
     "Humiliating a thoughtful interlocutor reads as unfair and costs the speaker credibility",
     "Concise claims are always weaker than long ones",
     "The argument was probably wrong"
    ],
    "ans": 1,
 ...
 "L3:5.5": {
  "read": [
   "A secular thinker must eventually answer a practical question that abstract metaphysics cannot settle: how should one live, argue, and build a shared civic life alongside neighbors who hold sincere religious commitments? Pluralism is the unavoidable condition of any large modern society, not a temporary defect to be engineered away. Within Ilu’s school we treat this as a feature rather than a failure. The disagreement between belief and unbelief runs deep, touching questions of meaning, authority, and the good life, and it will not be resolved by the next clever argument. The mature question is therefore not how to win, but how to disagree well while sharing schools, hospitals, courts, and streets.",
   "The core idea is a distinction between epistemic confidence and civic posture. One can hold, with full conviction, that theistic claims are unsupported, and still owe believers something more than mere endurance. Tolerance in its thin sense means refraining from coercion; the richer ideal these lessons defend is reciprocity, the willingness to offer reasons your interlocutor could in principle weigh, and to grant that thoughtful people land elsewhere for reasons that are not stupidity or cowardice. This rests on intellectual humility about the limits of any one person’s evidence and on recognizing that faith traditions carry centuries of moral reflection, communal practice, and lived wisdom that a debater dismisses at the cost of his own understanding.",
   "For debate, the implication is sharp. The most persuasive secular voice is rarely the most aggressive one; contempt reliably hardens an audience and confirms the caricature of the smug atheist. A charitable opponent who steelmans the believer’s position, concedes genuine difficulties on the secular side, and separates the argument from the person tends to move neutral listeners and even some committed ones. Ethical discourse also has limits worth naming: reciprocity does not require pretending all claims are equally evidenced, nor surrendering public reason to appeals that only insiders accept. The discipline is to be uncompromising about evidence and generous about persons at the same time, holding both without collapsing one into the other."
  ],
  "terms": [
   [
    "Pluralism",
    "The enduring social condition in which people holding incompatible religious and secular convictions must nonetheless share institutions and civic life together."
   ],
   [
    "Reciprocity",
    "The discursive commitment to offer reasons an interlocutor could in principle weigh and to assume their disagreement is held for serious, not contemptible, reasons."
   ],
   [
    "Public reason",
    "The practice of justifying shared rules and policies on grounds accessible to citizens generally, rather than on premises only one tradition already accepts."
   ],
   [
    "Steelmanning",
    "Engaging the strongest and most charitable version of an opponent’s argument rather than an easily defeated caricature of it."
   ]
  ],
  "quiz": [
   {
    "q": "In this lesson, what distinguishes thin tolerance from the richer ideal of reciprocity?",
    "opts": [
     "Thin tolerance merely refrains from coercion, while reciprocity offers reasons the other could weigh and credits their disagreement as serious",
     "Reciprocity requires abandoning your own conclusions to match the believer’s",
     "Thin tolerance applies only to political debate, reciprocity only to private life",
     "They are two names for the same attitude"
    ],
    "ans": 0,
    "ex": "Thin tolerance is simply not coercing others. Reciprocity goes further: it means giving reasons your interlocutor could <b>in principle weigh</b> and granting that thoughtful people disagree for serious reasons, not from stupidity or cowardice."
   },
   {
    "q": "According to the lesson, why is the most aggressive secular voice usually not the most persuasive in debate?",
    "opts": [
     "Because contempt is against the rules of formal debate",
     "Because aggression hardens an audience and confirms the caricature of the smug atheist",
     "Because neutral listeners never change their minds anyway",
     "Because believers cannot follow fast-paced argument"
    ],
    "ans": 1,
    "ex": "The lesson argues that contempt reliably <b>hardens an audience</b> and confirms the caricature of the smug atheist, whereas a charitable debater who steelmans the opposing view tends to move neutral and even committed listeners."
   },
   {
    "q": "What dual discipline does the lesson hold up as the mark of ethical secular discourse?",
    "opts": [
     "Treating all claims as equally evidenced to keep the peace",
     "Winning the argument while privately respecting the person",
     "Being uncompromising about evidence while generous about persons",
     "Avoiding religious topics entirely in public settings"
    ],
    "ans": 2,
 ...
 "L3:6.1": {
  ...
  "terms": [
   [
    "Motion",
    "The fixed proposition a debate is organized to defend or oppose, stated so that one side affirms it and the other denies it."
   ],
   [
    "Steelmanning",
    "Engaging the strongest, most defensible version of an opponent&rsquo;s argument rather than an easier, weakened restatement of it."
   ],
   [
    "Rebuttal",
    "A direct reply that identifies a specific weakness in the opposing case and gives a reason the audience should not accept it."
   ],
   [
    "Rubric",
    "The published scoring guide that tells judges which features of a debate to weigh and how much each is worth."
   ]
  ],
  "quiz": [
   {
    "q": "Why is a debater assigned a side rather than allowed to choose one?",
    "opts": [
     "So the exercise tests reasoning and the ability to carry a position, not personal conviction",
     "Because personal beliefs are not allowed in the school",
     "To make the debate shorter",
     "Because the panel cannot tell sides apart otherwise"
    ],
    "ans": 0,
    "ex": "Assigning sides means the capstone rewards <b>reasoning</b> rather than whatever the debater already happens to believe."
   },
   {
    "q": "What does the rubric reward when a debater addresses the opposing case?",
    "opts": [
     "Mocking the weakest version of it for laughs",
     "Ignoring it to save time for the positive case",
     "Engaging the opponent&rsquo;s best argument in a form the opponent would recognize",
     "Repeating one&rsquo;s own claims more loudly"
    ],
    "ans": 2,
    "ex": "Intellectual charity, or <b>steelmanning</b>, is scored: you must meet the strongest version of the opposing argument, not a caricature."
   },
   {
    "q": "According to the rubric, what are the four things the panel weighs?",
    "opts": [
     "Volume, speed, confidence, and humor",
     "Clarity of case, strength of evidence, quality of rebuttal, and charity toward the other side",
     "Length, vocabulary, audience size, and time used",
 ...
 "L3:6.2": {
  ...
  "terms": [
   [
    "Steelman",
    "The practice of restating an opposing argument in its strongest, most charitable form before responding to it, the opposite of attacking a straw man."
   ],
   [
    "Thesis",
    "A single, narrowly scoped, defensible claim that the whole essay exists to argue for, stated explicitly rather than left implicit."
   ],
   [
    "Oral defence",
    "The live, unscripted questioning session in which you must justify, qualify, or concede points of your written thesis in real time."
   ],
   [
    "Scope",
    "The explicit boundary of what a claim does and does not assert, which keeps an argument honest and prevents it from being judged against claims you never made."
   ]
  ],
  "quiz": [
   {
    "q": "What distinguishes a Route B thesis from a general survey of secular thought?",
    "opts": [
     "It must cover as many secular thinkers as possible",
     "It argues one narrow, defensible claim from premises to conclusion",
     "It must conclude that theism is false",
     "It avoids citing any sources"
    ],
    "ans": 1,
    "ex": "Route B is an <b>argued thesis</b>, not a survey or a polemic, it pursues a single defensible claim through to a conclusion you can own."
   },
   {
    "q": "Under the rubric, what does a properly steelmanned opposition look like?",
    "opts": [
     "The weakest version of the opposing case, so it is easy to refute",
     "An opposing case stated so strongly that a thoughtful theist would recognise their own view",
     "A list of reasons the opposition is acting in bad faith",
     "Omitting the opposition to keep the essay focused"
    ],
    "ans": 1,
    "ex": "A <b>steelman</b> presents the strongest, most charitable form of the opposing argument, so your thesis is tested against real pressure rather than a caricature."
   },
   {
    "q": "What does the oral defence primarily assess that the written essay cannot?",
    "opts": [
     "Word count and formatting",
     "How you respond to unscripted questions, conceding fair points without abandoning the core claim",
     "How many quotations you can recite from memory",
     "Whether your delivery is more persuasive than your opponent’s"
    ],
    "ans": 1,
